...
const FROM_ADDRESS = `Demo Showroom <${process.env.RESEND_SENDER_EMAIL || "onboarding@resend.dev"}>`;
...
<body
    ...
    <div style="max-width:680px;margin:0 auto;background-color:#ffffff;">
        ...
        <!-- HEADER -->
        <div
            style="background:linear-gradient(135deg,#0369a1,#60a5fa);padding:24px 30px;border-bottom-left-radius:40px;border-bottom-right-radius:40px;text-align:left;color:white;">
            <table width="100%">
                <tr>
                    <td align="left">
        ...
        <div style="max-width:600px;margin:40px auto;padding:40px 30px;text-align:center;">
            ...
            <p style="margin-top:40px;font-size:36px;font-weight:700;letter-spacing:12px;color:#60a5fa;">
                ${otp.split("").join(" ")}
            </p>
        </div>
        ...
        <!-- FOOTER -->
        <div
            style="max-width:480px;margin:40px auto 0;text-align:center;border-top:1px solid #e2e8f0;padding:30px 20px;">
            <p style="font-size:16px;font-weight:500;margin-top:0;margin-bottom:8px;color:#1e293b;">Demo Showroom</p>
            <p style="margin:0;color:#64748b;">RR4F+264, Menteng, Kec. Menteng, Kota Jakarta Pusat, Daerah Khusus
                Ibukota Jakarta</p>
            ...
            <p style="margin-top:20px;font-size:12px;color:#64748b;">&copy; ${currentYear} Demo Showroom. All rights
                reserved.</p>
        </div>
        ...
        <div style="max-width:600px;margin:40px auto;padding:40px 30px;text-align:center;">
            ...
            <div style="margin:30px 0;">
                <a href="${resetLink}" target="_blank"
                    style="background:linear-gradient(135deg,#0369a1,#60a5fa);color:#ffffff;padding:14px 28px;text-decoration:none;border-radius:8px;font-weight:600;display:inline-block;font-size:16px;">
                    Reset Kata Sandi
                </a>
            </div>
            <p style="font-weight:400;color:#64748b;line-height:1.6;">
                Tautan ini hanya berlaku selama <strong style="color:#60a5fa;">10 menit</strong>. Jika Anda tidak merasa
                meminta ini, Anda bisa mengabaikan email ini dengan aman.
            </p>
        </div>
...
<body
    ...
    <div style="max-width:680px;margin:0 auto;background-color:#ffffff;">
        ...
        <div style="max-width:600px;margin:40px auto;padding:40px 30px;text-align:left;">
            <h2 style="margin:0 0 24px 0;font-size:22px;font-weight:600;color:#1e293b;text-align:center;">Notifikasi
                Admin Baru</h2>
