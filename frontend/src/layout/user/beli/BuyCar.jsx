    ...
    <div>
      ...
      {!isMobileSearchFiltersOpen && (
        <button
          ...
          className="xl:hidden fixed bottom-50 -left-1 bg-gradient-to-r from-sky-300 to-sky-600 text-white px-3 py-2 rounded-r-full shadow-lg z-40 flex items-center gap-2 hover:from-sky-600 hover:to-sky-700 transition-all duration-300"
