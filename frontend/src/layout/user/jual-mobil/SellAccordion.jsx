...
const SellAccordion = () => {
  ...
  const accordionItems = [
    ...
    {
      title: "Apakah jual mobil di Demo Showroom aman?",
      description: [
        ...
        "Untuk memastikan keamanan bertransaksi di Demo Showroom, Anda bisa mencari ulasan dari penjual lain, memahami alur proses mereka secara detail, dan memastikan semua perjanjian tertulis dengan jelas.",
      ],
    },
    {
      title: "Bagaimana sistem pembayaran saat jual di Demo Showroom?",
      description: [
        "Sistem pembayaran dapat bervariasi antar platform. Umumnya, setelah mobil lolos inspeksi dan terjadi kesepakatan harga, prosesnya adalah:",
        {
          ...
          items: [
            ...
            "Pembeli (Demo Showroom atau rekanannya) melakukan verifikasi dokumen.",
            "Pembayaran dilakukan ke rekening penjual, biasanya melalui transfer bank.",
            "Bukti transfer diberikan kepada penjual.",
          ],
        },
        "Penting untuk mengkonfirmasi metode pembayaran, waktu pembayaran (kapan dana akan masuk), dan detail lainnya langsung dengan pihak Demo Showroom sebelum menyetujui penjualan.",
      ],
    },
  ];
  ...
  return (
    ...
    >
      <motion.div variants={itemVariants}>
        <TittleText
          text="FAQ Seputar Penjualan Mobil"
