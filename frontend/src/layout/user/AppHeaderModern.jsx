    ...
    <>
                ...
                <AnimatePresence>
                  {isDropdownOpen && (
                    ...
                    >
                      <Link
                        href="/sign-in"
                        className="block w-full text-left text-xs font-medium px-4 py-2 text-gray-700 hover:text-gray-700 hover:bg-sky-100 rounded-t-lg cursor-pointer"
                      >
                        Sign In
                      </Link>
                      <Link
      ...
      >
        <div className="relative flex items-center justify-between w-full h-full px-4">
          ...
          <Link
            href="/"
            className="absolute left-1/2 transform -translate-x-1/2 -top-8 w-16 h-16 bg-sky-500 rounded-full z-20 flex items-center justify-center shadow-lg cursor-pointer"
          >
