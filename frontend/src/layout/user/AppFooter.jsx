    ...
    >
      <div className="container mx-auto flex flex-col xl:flex-row items-start justify-between px-4 xl:px-0 gap-4 xl:gap-10 py-10 text-sm">
        <div className="">
          ...
          <p className="w-full text-gray-600">
            Demo Showroom merupakan platform showroom online untuk beli, jual,
            dan tukar tambah mobil secara mudah, cepat, dan terpercaya.
          </p>
        </div>
        ...
        <div className="lg:w-1/4">
          ...
          <ul className="flex flex-col gap-2 text-gray-600">
            <Link
              href="/beli"
              onClick={scrollToTop}
              className="hover:text-sky-600 cursor-pointer underline"
            >
              <li>Beli Mobil</li>
            </Link>
            <Link
        ...
        <div className="lg:w-1/4">
          ...
          <ul className="flex flex-col gap-2 text-gray-600">
            <li className="hover:text-sky-600 cursor-pointer underline">
              <a
                href="https://api.whatsapp.com/send/?phone=%2B6285810249867&text&type=phone_number&app_absent=0"
                target="_blank"
              >
      ...
      <div className="container mx-auto px-4 lg:px-0">
        ...
        <div className="py-5 text-sm text-gray-600 flex justify-center lg:justify-between lg:items-center">
          ...
          <p> Hak Cipta © 2025 Demo Showroom.</p>
        </div>
      </div>
    </div>
  );
