      ...
      if (user.avatar) {
        ...
        return (
          <div
            ...
            className="w-7 h-7 rounded-full bg-sky-500 text-white flex items-center justify-center text-xs font-semibold cursor-pointer hover:bg-sky-600 transition-colors"
          >
    ...
    <>
            ...
            <div className="hidden md:flex items-center md:space-x-4 lg:space-x-6">
              <Link
                ...
                className={`text-sm font-medium hover:text-sky-500 ${
                  pathname === "/" ? "text-sky-600" : "text-gray-700"
                }`}
              >
                Beranda
              </Link>
              <Link
                href="/beli"
                className={`text-sm font-medium hover:text-sky-500 ${
                  pathname === "/beli" ? "text-sky-600" : "text-gray-700"
                }`}
              >
                Beli Mobil
              </Link>
              ...
              <Link
                href="/tukar-tambah"
                className={`text-sm font-medium hover:text-sky-500 relative ${
                          ...
                          <>
                            ...
                            <ul className="flex flex-col gap-0 px-1 py-1">
                              <li>
                                <Link
                                  href="/profile"
                                  className="flex items-center gap-2.5 w-full text-left text-xs font-medium px-4 py-2.5 text-gray-700 hover:text-sky-600 hover:bg-sky-50 cursor-pointer transition-colors rounded-md"
                          ...
                          <>
                            <ul className="flex flex-col gap-0 px-1 py-1">
                              <li>
                                <Link
                                  href="/login"
                                  className="flex items-center gap-2.5 w-full text-left text-xs font-medium px-4 py-2.5 text-gray-700 hover:text-sky-600 hover:bg-sky-50 cursor-pointer transition-colors"
                                  onClick={() => setIsDropdownOpen(false)}
                                >
      ...
      >
        ...
        >
          <FaKey
            className={`w-5 h-5 ${
              pathname === "/jual-mobil" ? "text-sky-600" : "text-gray-700"
            }`}
          />
          <p
            className={`${
        ...
        >
          <FaArrowsRotate
            className={`w-5 h-5 ${
              pathname === "/tukar-tambah" ? "text-sky-600" : "text-gray-700"
            }`}
          />
          <p
            className={`${
