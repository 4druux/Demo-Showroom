  ...
  const accordionItems = [
    ...
    },
    {
      ...
      description: [
        ...
        "*Catatan: Kebutuhan dokumen dapat bervariasi, konfirmasikan daftar final dengan pihak Demo Showroom.*",
      ],
    },
    {
      ...
      description: [
        ...
        "*Catatan: Kriteria penerimaan spesifik dapat berbeda, hubungi Demo Showroom untuk detailnya.*",
      ],
    },
    {
    ...
    },
    {
      ...
      description: [
        ...
        "*Catatan: Alur transaksi spesifik dapat bervariasi, pastikan Anda mendapatkan penjelasan detail dari Demo Showroom.*",
      ],
    },
    {
      title: "Apakah proses tukar tambah di Demo Showroom aman?",
      description: [
        ...
        "*Catatan: Lakukan riset atau tanyakan langsung kepada Demo Showroom mengenai jaminan keamanan transaksi mereka.*",
      ],
    },
  ];
  ...
  return (
    ...
    >
      <motion.div variants={itemVariants}>
        <TittleText
          text="FAQ Seputar Tukar Tambah Mobil"
