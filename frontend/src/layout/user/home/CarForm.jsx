...
const CarForm = () => {
  ...
  return (
    ...
    >
      <div className="flex w-full bg-gray-200 lg:w-fit rounded-t-3xl border-t-4 border-t-sky-500 md:border-none shadow-md">
        {/* Tab Beli Mobil */}
        <button
          ...
          className={`relative w-full lg:w-fit rounded-tl-3xl lg:rounded-tl-2xl rounded-br-2xl cursor-pointer ${
            activeTab === "beli"
              ? "bg-white text-sky-500 hover:text-sky-600 before:absolute before:-right-5 before:top-0 before:h-6 before:w-10 before:bg-gray-200 before:content-[''] after:absolute after:top-0 after:right-0 after:h-6 after:w-5 after:rounded-tr-3xl after:bg-white after:content-['']"
              : activeTab === "jual"
        ...
        <button
          ...
          className={`relative w-full lg:w-fit rounded-tl-2xl cursor-pointer ${
            activeTab === "jual"
              ? "bg-white text-sky-500 hover:text-sky-600 before:absolute before:-right-5 before:top-0 before:h-6 before:w-10 before:bg-gray-200 before:content-[''] after:absolute after:top-0 after:right-0 after:h-6 after:w-6 after:rounded-tr-2xl after:bg-white after:content-['']"
              : activeTab === "tukar"
              ? "bg-gray-200 text-gray-500 hover:text-gray-700 before:absolute before:-right-3 before:bottom-0 before:h-6 before:w-6 before:bg-white before:content-[''] after:absolute after:bottom-0 after:right-0 after:h-6 after:w-4 after:rounded-br-3xl after:bg-gray-200 after:content-['']"
        ...
        <button
          ...
          className={`relative w-full lg:w-fit rounded-tr-3xl lg:rounded-tr-2xl rounded-bl-2xl cursor-pointer ${
            activeTab === "tukar"
              ? "bg-white text-sky-500 hover:text-sky-600 before:absolute before:-left-5 before:top-0 before:h-6 before:w-10 before:bg-gray-200 before:content-[''] after:absolute after:left-0 after:top-0 after:h-6 after:w-5 after:rounded-tl-3xl after:bg-white after:content-['']"
              : activeTab === "jual"
