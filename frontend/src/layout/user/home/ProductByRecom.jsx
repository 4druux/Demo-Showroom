    ...
    >
      ...
      >
        ...
        <div className="block md:hidden">
          <Link href="/beli">
            <p className="text-xs text-sky-500 font-medium hover:text-sky-600 hover:text-underline hover:underline cursor-pointer">
              Tampilkan Semua
            </p>
          </Link>
        </div>
      ...
      <div className="hidden md:block">
        <div className="flex flex-col items-center">
          ...
          <Link href="/beli">
            <p className="text-sm text-sky-500 font-medium hover:text-sky-600 hover:text-underline hover:underline cursor-pointer">
