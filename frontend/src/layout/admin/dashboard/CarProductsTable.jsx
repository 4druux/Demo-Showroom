                ...
                >
                  <div className="flex flex-1 items-start sm:col-span-4 sm:flex sm:items-center sm:gap-x-3">
                    ...
                    <div className="ml-3 sm:ml-0 flex-1 min-w-0">
                      <p className="text-sm font-semibold text-gray-800 line-clamp-1 group-hover:text-sky-600 transition-colors">
                  ...
                  <div className="hidden sm:flex sm:col-span-2 sm:items-center text-sm text-sky-600 font-medium sm:justify-start">
                    {formatPrice(product.price)}
                  </div>
