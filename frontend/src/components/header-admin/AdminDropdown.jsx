        ...
        <>
          {user.avatar ? (
            ...
            <div
              ...
              className="w-8 h-8 lg:w-9 lg:h-9 rounded-full bg-sky-500 hover:bg-sky-600 text-white flex items-center justify-center text-xs font-semibold select-none cursor-pointer transition-colors"
            >
