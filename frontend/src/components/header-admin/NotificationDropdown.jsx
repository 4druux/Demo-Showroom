    ...
    <div className="relative" ref={dropdownRef}>
      ...
      >
        {hasUnreadNotifications ? (
          <>
            <AnimatedBell size={20} color="#0ea5e9" className="w-5 h-5" />
            <span className="absolute right-0 top-0 z-10 h-2 w-2 bg-sky-500 rounded-full">
              <span className="absolute -right-0.5 -top-0.5 z-10 h-3 w-3 bg-sky-500 rounded-full opacity-75 animate-ping"></span>
            </span>
          </>
        ) : (
                        ...
                        <div className="flex gap-3">
                          ...
                          <div className="flex-1">
                            <div className="flex justify-between">
                              ...
                              {!notification.isRead && (
                                <span className="inline-block w-2 h-2 bg-sky-500 animate-pulse rounded-full"></span>
                              )}
                            </div>
