                  ...
                  <>
                    ...
                    >
                      <button
                        ...
                        className="p-2 rounded-full bg-sky-200 border border-sky-300"
                      >
            ...
            {previewURLs[index] ? (
              <>
                ...
                <div className="absolute inset-0 flex justify-center items-center rounded-lg bg-black/40 opacity-0 group-hover:opacity-100">
                  ...
                  >
                    <Trash2 className="w-12 h-12 text-white hover:text-sky-600 p-3 rounded-full hover:bg-sky-100 cursor-pointer" />
                  </button>
                  <button type="button" onClick={() => handleEditImage(index)}>
                    <Pencil className="w-12 h-12 text-white hover:text-sky-600 p-3 rounded-full hover:bg-sky-100 cursor-pointer" />
                  </button>
                </div>
              </>
            ) : (
