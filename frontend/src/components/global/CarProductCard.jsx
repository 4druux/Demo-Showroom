                ...
                <div>
                  ...
                  <div className={`p-4 ${isAdminRoute ? "pb-2" : "p-6"}`}>
                    ...
                    >
                      ...
                      <p className="text-sky-500 font-medium text-lg mt-2">
                ...
                <>
                  ...
                  >
                    <button
                      ...
                      className={`p-1 rounded-full border border-gray-100 bg-gray-100 hover:bg-sky-200 hover:border-sky-500
                    ...
                    >
                      <Ellipsis
                        className={`w-4 h-4 text-gray-700 group-hover:text-sky-600 ${
                          isDropdownOpen[product._id] ? "text-sky-600" : ""
                        }`}
                      />
                    </button>
                    <AnimatePresence>
                      {isDropdownOpen[product._id] && (
                        ...
                        >
                          <button
                            ...
                            className="flex items-center justify-center w-full text-xs px-3 py-2 text-gray-700 hover:bg-sky-50 hover:text-sky-600 cursor-pointer rounded-lg"
                          >
                            {isMarkingAsSold ? (
