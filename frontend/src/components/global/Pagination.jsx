    ...
    <div className="flex justify-center mt-4 md:mt-8">
      <ReactPaginate
        ...
        pageClassName={`relative w-8 h-8 flex items-center justify-center rounded-full cursor-pointer text-sm font-medium 
              transition-all duration-300 hover:-translate-y-1 text-sky-500`}
        previousClassName={`flex items-center space-x-2 px-3 py-2 rounded-full ${
          currentPage === 0
            ? "cursor-not-allowed"
            : "hover:bg-sky-100 hover:-translate-y-1 transition-all duration-300"
        }`}
        ...
        breakClassName={"px-3 py-2 text-sky-600 select-none"}
        activeClassName={"bg-sky-100 text-sky-600 shadow-md scale-105"}
