              ...
              <button
                ...
                className={`text-xs rounded-full transition-colors cursor-pointer ${
                  isMobile
                    ...
                    : "py-1 px-3 bg-gray-50 text-gray-700 border border-gray-100 hover:bg-sky-100 hover:text-sky-500  hover:border-sky-500"
                }`}
              >
                {searchTerm}
              </button>
              ...
              >
                ...
                <span
                  className={`text-xs rounded-full transition-colors cursor-pointer group ${
                    isMobile
                      ? "py-1 px-2 bg-gray-100 text-gray-700"
                      : "py-.5 px-2 bg-gray-50 text-gray-700 border border-gray-100 group-hover:bg-sky-100 group-hover:text-sky-500 group-hover:border-sky-500"
                  }`}
                >
                  {brandItem.name}
                </span>
