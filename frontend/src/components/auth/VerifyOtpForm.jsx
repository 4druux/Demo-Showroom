        ...
        <Link href="/">
          <div className="flex items-center justify-center">
            <Image
              ...
              height={35}
              priority
              className="w-auto h-auto max-w-[300px] max-h-[80px] object-cover"
            />
          </div>
        </Link>
      </div>
          ...
          >
            {otp.map((value, index) => (
              <input
                ...
                className="w-12 h-14 md:w-14 md:h-16 text-center text-2xl font-medium text-gray-600 border border-gray-300 focus:outline-none rounded-lg focus:border-2 focus:border-sky-300 transition"
              />
            ))}
          </div>
          ...
          <p className="text-sm text-gray-600">
            ...
            {isResendDisabled ? (
              ...
              <button
                ...
                className="font-medium text-sky-600 hover:underline disabled:text-gray-400 disabled:cursor-not-allowed cursor-pointer"
              >
