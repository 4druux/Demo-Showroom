        ...
        <div className="flex flex-col items-center space-y-3">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-sky-600 bg-sky-100 border border-sky-200 rounded-full hover:bg-sky-200 transition-colors cursor-pointer"
            >
