      ...
      >
        <div className="p-4 border-b border-gray-700 flex justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="p-2 rounded-full hover:bg-sky-100 border border-gray-100 hover:border-sky-500 cursor-pointer transition-colors group"
          >
            <XIcon className="w-5 h-5 text-gray-600 group-hover:text-sky-500" />
          </button>
        </div>
