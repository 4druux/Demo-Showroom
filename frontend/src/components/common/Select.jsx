      ...
      <div className="relative" ref={dropdownRef}>
        ...
        <button
          ...
          className={`mt-1 flex items-center justify-between w-full border rounded-xl py-2.5 px-3 cursor-pointer text-left
            ${isDropdownOpen ? "border-sky-300" : "border-gray-300"}
            ${
                    ...
                    {searchOption && (
                      <div className="relative my-2">
                        <input
                          ...
                          className="w-full border border-gray-300 rounded-full px-3 py-1.5 my-2 text-base md:text-sm placeholder:text-xs focus:outline-none focus:ring-1 focus:ring-sky-300"
                        />
                        {searchTerm && (
                          <button
                            type="button"
                        ...
                        >
                          <label className="flex-grow flex items-center text-sm py-2 px-3 cursor-pointer">
                            ...
                            <input
                              ...
                              className="form-radio h-4 w-4 accent-sky-600 ml-auto"
                            />
                          </label>
