...
const CarPricingInfo = ({ product, variants }) => {
  ...
  const generateWhatsAppMessage = (includeTenor = false) => {
    let message = `Halo Kak, Saya lihat mobil ini di website DemoShowroom.id\n\n`;
  ...
  return (
    <>
      <motion.div
        variants={variants}
        ref={pricingInfoRef}
        className="p-4 md:p-8 rounded-t-3xl md:rounded-3xl border-t-4 border-t-sky-500 border-b border-gray-300 md:border-none md:shadow-md bg-white"
      >
        <motion.div
        ...
        {product.status === "Terjual" ? (
          <motion.div variants={contentVariants}>
            ...
            <div className="mt-6 flex flex-col md:flex-row gap-3 w-full mx-auto">
              <ButtonMagnetic
                ...
                className="w-full !py-3.5 !m-0 text-green-600 group-hover:text-white"
          ...
          <>
            <motion.div
              ...
              className="mt-4 p-4 bg-sky-50 rounded-xl"
            >
        ...
        {product.status === "Terjual" ? (
          ...
          >
            <div className="flex-1">
              <p className="text-md font-semibold text-sky-600 truncate">
                Rp {product.price.toLocaleString("id-ID")}
              </p>
              {selectedTenor && (
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={handleTradeInClick}
                className="p-3 border border-sky-600 text-sky-600 rounded-full hover:bg-sky-50 transition duration-200"
